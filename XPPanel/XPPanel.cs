...
namespace UIComponents {
	...
	///			<description>Set the style of the <c>XPPanel</c> - <see cref="UIComponents.XPPanelStyle.Custom"/> or 
	///			<see cref="UIComponents.XPPanelStyle.WindowsXP"/></description>
	///		</item>
	///	</list>
	///	</para>
	///	<para>
	...
	///	</para>
	/// </remarks>
	[TypeConverter(typeof(UIComponents.Designers.XPPanelTypeConverter))]
	public class XPPanel : System.Windows.Forms.Panel {
		...
		/// <see cref="UIComponents.XPPanelStyle.WindowsXP"/>
		/// </summary>
			...
			get {
				lock(typeof(XPPanel)) {
					if (xpStyleExpandGlyphs == null) {
						...
						try {
							xpStyleExpandGlyphs.ImageSet = new ImageSet(LoadBitmap("UIComponents.xp.style.glyphs.png"),4) ;
			...
			get {
				lock(typeof(XPPanel)) {
					if (xpStyleCollapseGlyphs == null) {
						...
						try {
							xpStyleCollapseGlyphs.ImageSet = new ImageSet(LoadBitmap("UIComponents.xp.style.glyphs.png"),4) ;
		...
		/// </summary>
		/// <remarks>
		/// <see cref="UIComponents.XPPanelStyle.Custom"/> uses all user-defined settings, while 
		/// <see cref="UIComponents.XPPanelStyle.WindowsXP"/> provides overrides to certain properties
		/// to provide a <c>WindowsXP</c> look and feel.
		/// <para>
		/// Currently, <see cref="UIComponents.XPPanelStyle.WindowsXP"/>, overrides user-specified values
