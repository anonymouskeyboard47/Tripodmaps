...
namespace UIComponents {
	...
	public class TextLayoutPanel : Panel {
			...
			set {
				if (textElementCollection != value) {
					if (textElementCollection != null) {
						...
						textElementCollection.ElementChange -= new UIComponents.TextElementPropertyChangeEventHandler(textElementCollection_ElementChange);
					}
		...
		/// </summary>
		/// <remarks>
		/// When the <see cref="BackgroundStyle"/> is <see cref="UIComponents.BackgroundStyle.Solid"/>
		...
		/// 
		/// In the case of <see cref="UIComponents.BackgroundStyle.Transparent"/> the result is <b>undefined</b>
		/// </remarks>
		...
		private void textElementCollection_ElementChange(object sender, UIComponents.TextElementPropertyChangeEventArgs e) {
			switch(e.Property) {
	...
	public class TextElementCollection : CollectionBase {
		...
		public void Insert(int index,ITextElement textElement) {
			if (textElement != null) {
				...
				textElement.PropertyChange += new UIComponents.TextElementPropertyChangeEventHandler(TextElementCollection_PropertyChange);
		...
		protected override void OnInsertComplete(int index, object value) {
			...
			((ITextElement) value).PropertyChange += new UIComponents.TextElementPropertyChangeEventHandler(TextElementCollection_PropertyChange);
			OnChangeEvent() ;
		}
		...
		protected override void OnSetComplete(int index, object oldValue, object newValue) {
			...
			if (oldValue != null) {
				((ITextElement) oldValue).PropertyChange -= new UIComponents.TextElementPropertyChangeEventHandler(TextElementCollection_PropertyChange);
			}

			if (newValue != null) {
				((ITextElement) newValue).PropertyChange += new UIComponents.TextElementPropertyChangeEventHandler(TextElementCollection_PropertyChange);
			}
		...
		private void TextElementCollection_PropertyChange(object sender, UIComponents.TextElementPropertyChangeEventArgs e) {
	...
	/// </summary>
	[Serializable]
	[TypeConverter(typeof(UIComponents.Designers.TextElementTypeConverter))]
	...
	public class TextElement : ITextElement {
		...
		/// <summary>
		/// Get the <see cref="UIComponents.TextStyle.SpacingAdjustment"/>
		/// associated with the <c>ITextElement</c>
		/// </summary>
		/// <remarks>
		/// If no <see cref="TextStyle"/> is associated with this <c>TextElement</c> this 
