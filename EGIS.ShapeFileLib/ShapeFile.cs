...
//give the Tripodmaps.Viewer access to the internal methods
//[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("Tripodmaps.Viewer,     PublicKey=")]
//[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("Tripodmaps.Web.Controls, PublicKey=")]
namespace Tripodmaps.Reader
{
    ...
    /// The ShapeFile class is the main class of the Tripodmaps.Reader namespace    
    /// </summary>
    /// <remarks>    
    ...
    class SFPolyLineExCol : SFRecordCol, QTNodeHelper
    {
        ...
        public SFPolyLineExCol(PolyLineRecordEx[] recs, ShapeFileMainHeaderEx head)
            : base(head)
        {
            this.Recs = recs;
        }
    ...
    class SFPolyLineMExCol : SFRecordCol
    {
        ...
        public SFPolyLineMExCol(PolyLineMRecordEx[] recs, ShapeFileMainHeaderEx head)
            : base(head)
        {
            this.Recs = recs;
        }
    ...
    class SFPolygonExCol : SFRecordCol, QTNodeHelper
    {
        ...
        public SFPolygonExCol(PolygonRecordEx[] recs, ShapeFileMainHeaderEx head)
            : base(head)
        {
            this.Recs = recs;
        }
    ...
    class SFPointExCol : SFRecordCol
    {
        ...
        public SFPointExCol(PointRecordEx[] recs, ShapeFileMainHeaderEx head)
            : base(head)
        {
            this.Recs = recs;
        }
    ...
    public sealed class DbfReader : IDisposable
    {
        ...
        public unsafe string GetField(int recordNumber, int fieldIndex)
        {
            ...
            int FieldOffset = this.dBFRecordHeader.HeaderLength + this.dBFRecordHeader.RecordLength * recordNumber + 
                this.dBFRecordHeader.GetFieldDescriptions()[fieldIndex].RecordOffset;
        ...
        /// <summary>
        /// Gets a two dimensional array of strings representing all records for the specified field indexes.
        /// Each string in the returned array is trimmed to remove trailing spaces
        /// </summary>
        /// <param name="fieldIndex">Zero based index of the field in the DBF file</param>
        /// <param name="fieldIndex2">Zero based index of the second field in the DBF file</param>
        /// <returns></returns>
        public string[,] GetRecordsTwoFields(int fieldIndex, int fieldIndex2)
        {
            try
            {
                string[,] records = new string[this.dBFRecordHeader.RecordCount, 2];
                for (int n = 0; n < this.dBFRecordHeader.RecordCount; n++)
                {
                    records[n, 0] = this.GetField(n, fieldIndex).Trim();

                    if (this.GetField(n, fieldIndex2).Trim() != null)
                    {
                        if (this.GetField(n, fieldIndex2).Trim() != "")
                        {
                            records[n, 1] = this.GetField(n, fieldIndex2).Trim();
        ...
        /// <param name="fieldIndex">Zero based index of the field in the DBF file</param>
        /// <param name="fieldIndex2">Zero based index of the second field in the DBF file</param>
        /// <param name="fieldIndex3">Zero based index of the second field in the DBF file</param>
        /// <param name="fieldIndex4">Zero based index of the second field in the DBF file</param>
        /// <returns></returns>
        public string[,] GetRecordsFourFields(int fieldIndex, int fieldIndex2, int fieldIndex3, int fieldIndex4)
        {
            try
            {
                string[,] records = new string[this.dBFRecordHeader.RecordCount, 4];
                for (int n = 0; n < this.dBFRecordHeader.RecordCount; n++)
                {
                    records[n, 0] = this.GetField(n, fieldIndex).Trim();

                    if (!(string.IsNullOrEmpty(this.GetField(n, fieldIndex2).Trim())))
                    {
                        records[n, 1] = this.GetField(n, fieldIndex2).Trim();
                    }


                    if (!(string.IsNullOrEmpty(this.GetField(n, fieldIndex3).Trim())))
                    {                        
                        records[n, 2] = this.GetField(n, fieldIndex3).Trim();
                    }


                    if (!(string.IsNullOrEmpty(this.GetField(n, fieldIndex4).Trim())))
                    {
                        records[n, 3] = this.GetField(n, fieldIndex4).Trim();
                    }
    ...
    public sealed class ShapeFileEnumerator : IEnumerator<System.Collections.ObjectModel.ReadOnlyCollection<PointD[]>>
    {
        ...
        internal ShapeFileEnumerator(ShapeFile shapeFile, RectangleD extent)
            : this(shapeFile, extent, IntersectionType.Intersects)
        {
        }
