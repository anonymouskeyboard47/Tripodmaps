...
{
    /// <summary>Converts <see cref="T:Tripodmaps.Reader.SizeD"></see> objects from one type to another.</summary>
    public class SizeDConverter : TypeConverter
    {
        /// <summary>Returns a value indicating whether the converter can convert from the type specified to the <see cref="T:Tripodmaps.Reader.SizeD"></see> type, using the specified context.</summary>
        ...
        /// <summary>Returns a value indicating whether the <see cref="T:Tripodmaps.Reader.SizeDConverter"></see> can convert a <see cref="T:Tripodmaps.Reader.SizeD"></see> to the specified type.</summary>
        ...
        /// <summary>Creates an instance of a <see cref="T:Tripodmaps.Reader.SizeD"></see> with the specified property values using the specified context.</summary>
        /// <returns>An <see cref="T:System.Object"></see> representing the new <see cref="T:Tripodmaps.Reader.SizeD"></see>, or null if the object cannot be created.</returns>
        ...
        /// <summary>Returns a value indicating whether changing a value on this object requires a call to the <see cref="Tripodmaps.Reader.SizeDConverter.CreateInstance"></see> method to create a new value.</summary>
        ...
        /// <summary>Retrieves a set of properties for the <see cref="T:Tripodmaps.Reader.SizeD"></see> type using the specified context and attributes.</summary>
        ...
        /// <summary>Returns whether the <see cref="T:Tripodmaps.Reader.SizeD"></see> type supports properties.</summary>
        /// <returns>Always returns true.</returns>
        /// <param name="context">An <see cref="T:System.ComponentModel.ITypeDescriptorContext"></see> through which additional context can be supplied.</param>
