...
namespace Tripodmaps.Reader
{
	...
	public sealed class ConversionFunctions
	{
        ...
        /// WGS-84 Ellipse    
        /// </summary>
		public static int RefEllipse = 23; //WGS84
		...
		internal static double DistanceBetweenLatLongPointsHaversine(int referenceEllipsoid, LatLongCoordinate origin, 
            LatLongCoordinate destination)
		{
        ...
        /// <returns></returns>
		public static double DistanceBetweenLatLongPoints(int referenceEllipsoid, LatLongCoordinate origin, 
            LatLongCoordinate destination)
		{
        ...
        /// <returns></returns>
        public static double DistanceBetweenLatLongPoints(int referenceEllipsoid, double latOrigin, double longOrigin, 
            double latDestination, double longDestination)
        {
            //Convert the latitude long decimal degrees to radians and apply the formula
            //use the proper ellipsoid to get raidus of the earth
            double EquatorialRadius = EllipseCollection[referenceEllipsoid].EquatorialRadius;
		...
		*/
        ...
        public static System.Drawing.PointF LLToUtm2(double latitude, double longitude, double eqRadius, 
            double inverseFlattening, double scaleFactor)
        {
            double f = 1 / inverseFlattening;
            return LLToUtm(latitude, longitude, eqRadius, 1 - ((1 - f) * (1 - f)), scaleFactor);
        }
        
        public static System.Drawing.PointF LLToUtm(double latitude, double longitude, double eqRadius, 
            double eccSquared, double scaleFactor)
        {
            //converts latitude/long to UTM coords.  Equations from USGS Bulletin 1532 
            //East Longitudes are positive, West longitudes are negative. 
            //North latitudes are positive, South latitudes are negative
        ...
        /// </para>
        /// </remarks>
        public static System.Drawing.PointF ToLL2(System.Drawing.PointF inPoint, double centralMeridian, 
            double latOrigin, double falseEasting, double falseNorthing, double scaleFactor, 
            double equatorialRadius, double inverseFlattening)
        {
            double f = 1/inverseFlattening;
        ...
        /// </para>
        /// </remarks>
        public static System.Drawing.PointF ToLL(System.Drawing.PointF inPoint, double centralMeridian, 
            double latOrigin, double falseEasting, double falseNorthing, double scaleFactor, 
            double equatorialRadius, double eccSquared)
        {
            //converts UTM coords to latitude/long.  Equations from USGS Bulletin 1532 
            //East Longitudes are positive, West longitudes are negative. 
            //North latitudes are positive, South latitudes are negative
        ...
        /// </remarks>
        public static System.Drawing.PointF ToLL(System.Drawing.PointF inPoint, double centralMeridian, 
            double latOrigin, double falseEasting, double falseNorthing, double scaleFactor, Ellipsoid ellipsoid)
        {
