...
namespace Tripodmaps.Reader
{
    ...
    /// </para>
    /// <para>Note that in order to use Map tiles the <see cref="Tripodmaps.Reader.ShapeFile.UseMercatorProjection"/> property
    ...
    /// </code>      
    /// </para>
    /// <seealso cref="Tripodmaps.Reader.ShapeFile.UseMercatorProjection"/>
    /// </remarks>
