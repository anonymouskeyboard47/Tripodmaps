...
** All rights reserved.
**
** This file is part of the Tripodmaps.Viewer class library of Easy GIS .NET.
** 
...
namespace Tripodmaps.Viewer
{
    ...
    /// </summary>
    /// <remarks>
    /// This is the main control in the Tripodmaps.Viewer namespace
    /// <para>
    ...
    public partial class MapViewer : UserControl
    {
        ...
        public int MouseRecord
        {
            get
            {
                return intMouseRecord;
            }
            set
            {
                intMouseRecord = value;
            }
        }
        ...
        public string ShapefileName
        {
            get
            {
                return strShapefileName;
            }
            set
            {
                strShapefileName = value;
            }
        }
        ...
        private List<Tripodmaps.Reader.ShapeFile> myShapefiles = new List<Tripodmaps.Reader.ShapeFile>();
...
#region events
        ...
        /// <see cref="Tripodmaps.Reader.RenderSettings.UseToolTip"/>
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            foreach (Tripodmaps.Reader.ShapeFile sf in myShapefiles)
            {
                sf.WriteXml(writer);
            }
        ...
        public void ReadXml(XmlElement projectElement, ProgressLoadStatusHandler loadingDelegate)
        {
            ...
            try
            {
                ...
                if (sfList != null && sfList.Count > 0)
                {
                    ...
                    {
                        Tripodmaps.Reader.ShapeFile sf = new Tripodmaps.Reader.ShapeFile();

                        sf.AppPath = Application.StartupPath;
                    ...
                    RectangleF r = new RectangleF(36.81232f, -1.295072f, 0.0007286072f, 0.0007714033f);
                    ...
                    LocateShape(pxPoint, GisPointToPixelCoord(36.81232f, -1.295072f));
        ...
        /// </para>        
        /// </remarks>
        /// <seealso cref="Tripodmaps.Reader.RenderQuality"/>
        public Tripodmaps.Reader.RenderQuality RenderQuality
        {
            get
            {
                return Tripodmaps.Reader.ShapeFile.RenderQuality;
            }
            set
            {
                Tripodmaps.Reader.ShapeFile.RenderQuality = value;
                dirtyScreenBuf = true;
                Invalidate();
            }
        }
        ...
        public bool UseMercatorProjection
        {
            get
            {
                return Tripodmaps.Reader.ShapeFile.UseMercatorProjection;
            }
            set
            {
                if (Tripodmaps.Reader.ShapeFile.UseMercatorProjection == value) return;
                Tripodmaps.Reader.ShapeFile.UseMercatorProjection = value;
                if (value)
                {
                    _centrePoint = Tripodmaps.Reader.ShapeFile.LLToMercator(_centrePoint);
                }
                else
                {
                    _centrePoint = Tripodmaps.Reader.ShapeFile.MercatorToLL(_centrePoint);
                }
                Refresh(true);
            }
        }
        ...
        public Tripodmaps.Reader.ShapeFile FindShapeFileBypath(string path)
        {
        ...
        /// </remarks>
        public Tripodmaps.Reader.ShapeFile AddShapeFile(string path, string name, string labelFieldName)
        {            
            Tripodmaps.Reader.ShapeFile sf = OpenShapeFile(path, name, labelFieldName);
        ...
        public void RemoveShapeFile(Tripodmaps.Reader.ShapeFile shapeFile)
        {            
        ...
        /// <returns></returns>
        public Tripodmaps.Reader.ShapeFile this[int index]
        {
            get
            {                
                return myShapefiles[index];
        ...
        /// </summary>        
        /// <returns></returns>
        public Tripodmaps.Reader.ShapeFile this[string shapeFilePath]
        {
            get
            {
        ...
        public void MoveShapeFileUp(Tripodmaps.Reader.ShapeFile shapeFile)
        {
        ...
        public void MoveShapeFileDown(Tripodmaps.Reader.ShapeFile shapeFile)
        {
            int index = myShapefiles.IndexOf(shapeFile);
        ...
        private Tripodmaps.Reader.ShapeFile OpenShapeFile(string path, string name, string renderFieldName)
        {
            ...
            sf.RenderSettings = new Tripodmaps.Reader.RenderSettings(path, renderFieldName, new Font(this.Font.FontFamily, 6f));
            LoadOptimalRenderSettings(sf);
            myShapefiles.Add(sf);
            return sf;
        }

        protected static void LoadOptimalRenderSettings(Tripodmaps.Reader.ShapeFile sf)
        {
            RectangleF r = sf.Extent;
            ...
            else
            {
                ...
                Tripodmaps.Reader.UtmCoordinate utm1 = Tripodmaps.Reader.ConversionFunctions.LLToUtm(Tripodmaps.Reader.ConversionFunctions.RefEllipse, pt.Y, pt.X);
                Tripodmaps.Reader.UtmCoordinate utm2 = utm1;
                utm2.Northing += 15;
                Tripodmaps.Reader.LatLongCoordinate ll = Tripodmaps.Reader.ConversionFunctions.UtmToLL(Tripodmaps.Reader.ConversionFunctions.RefEllipse, utm2);
        ...
        public void LocateShape(PointD pt, Point mousePos)
        {
            ...
            for (int l = ShapeFileCount - 1; l >= 0; l--)
            {
                ...
                bool useCustomToolTip = (useToolTip && this[l].RenderSettings.CustomRenderSettings != 
                    null && this[l].RenderSettings.CustomRenderSettings.UseCustomTooltips);

                RectangleF layerExtent = this[l].GetActualExtent();
                layerExtent.Inflate((float)delta, (float)delta);
                
                if ((this[l].IsSelectable || useToolTip) && layerExtent.Contains(ptf) && 
                    this[l].IsVisibleAtZoomLevel((float)ZoomLevel))
                {
                    ...
                    if (selectedIndex >= 0)
                    {
                        ...
                        if (_useHints)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    string temp = this[l].RenderSettings.DbfReader.GetField(selectedIndex, 
                                        this[l].RenderSettings.ToolTipFieldIndex).Trim();
        ...
        /// <summary>
        /// Returns object Index where OnMouseUp event was triggered
        /// </summary>
        /// <param name="pt">Mouse coordinates converted from screen coordinates into Geo coordinates</param>
        /// <param name="mousePos">Mouse coordinates from the mouseup event</param>
        /// <param name="strArgShapefileName">Name of shapefile to filter out the coordinates from</param>
        public int LocateShapeIndexOnMouseUp(PointD pt, Point mousePos, string strArgShapefileName)
        {
            int selectedIndex = -1;

            if (!string.IsNullOrEmpty(strArgShapefileName))
            {                
                lastLocateMousePos = mousePos;
                double delta = 8.0 / ZoomLevel;
                PointF ptf = new PointF((float)pt.X, (float)pt.Y);
                ...
                for (int l = ShapeFileCount - 1; l >= 0; l--)
                {
                    if (this[l].Name == strArgShapefileName)
                    {
                        RectangleF layerExtent = this[l].GetActualExtent();
                        layerExtent.Inflate((float)delta, (float)delta);

                        if ((layerExtent.Contains(ptf) && this[l].IsVisibleAtZoomLevel((float)ZoomLevel)))
                        {
                            selectedIndex = this[l].GetShapeIndexContainingPoint(pt, delta);
                        }
                    }
                }
            }
        ...
        /// <param name="pt">Mouse coordinates converted from screen coordinates into Geo coordinates</param>
        /// <param name="strArgShapefileName">Name of shapefile to filter out the coordinates from</param>
        public int LocateShapeIndexAtPoint(PointD pt, string strArgShapefileName)
        {
            int selectedIndex = -1;
        ...
        /// <summary>
        /// Returns string value of iReturnIndex field
        /// </summary>
        /// <param name="shpArgShapeFile">Mouse coordinates converted from screen coordinates into Geo coordinates</param>
        /// <param name="iArgSelectedIndex">Field containing the shapefile's index field</param>
        /// <param name="iReturnIndex">Field to retrieve the value from</param>
        public string GetFieldValueOfSelectedIndex(Tripodmaps.Reader.ShapeFile shpArgShapeFile, 
            int iArgSelectedIndex, int iReturnIndex)
        {
            string strReturnIndexValue = "";
            
            try
            {

                if (shpArgShapeFile != null)
                {
                    if (iArgSelectedIndex >= 0)
                    {
                        strReturnIndexValue = "";
                        {
                            //Return value as in iReturnIndex (Ensure this field is unique)
                            strReturnIndexValue = shpArgShapeFile.RenderSettings.DbfReader.GetField(iArgSelectedIndex,
                                iReturnIndex).Trim();
                        }
                    }
                }

                return strReturnIndexValue;
            }
        ...
        private void SFMap_Load(object sender, EventArgs e)
        {
