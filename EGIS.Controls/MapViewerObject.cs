...
namespace Tripodmaps.Viewer
{
    ...
    /// </summary>
    public partial class MapViewerObject : UserControl
    {
        ...
        private void btnMoveUp_Click(object sender, EventArgs e)
        {
            ...
            {
                Tripodmaps.Reader.ShapeFile sf = lstShapefiles.SelectedItem as Tripodmaps.Reader.ShapeFile;
                _map.MoveShapeFileUp(lstShapefiles.SelectedItem as Tripodmaps.Reader.ShapeFile);
        ...
        private void btnMoveDown_Click(object sender, EventArgs e)
        {
            ...
            {
                Tripodmaps.Reader.ShapeFile sf = lstShapefiles.SelectedItem as Tripodmaps.Reader.ShapeFile;
                _map.MoveShapeFileDown(lstShapefiles.SelectedItem as Tripodmaps.Reader.ShapeFile);
                lstShapefiles.SelectedItem = sf;
            }
        ...
        /// shapefiles
        /// </summary>
        public Tripodmaps.Reader.ShapeFile SelectedShapeFile
        {
            get
            {
                return this.lstShapefiles.SelectedItem as Tripodmaps.Reader.ShapeFile;
            }
        }
        ...
        protected virtual void SetMap(MapViewer map)
        {
            this._map = map;
            if (map != null)
            {
        ...
        private void map_ShapeFilesChanged(object sender, EventArgs args)
        {
            ...
            if(Map == null) return;
            Tripodmaps.Reader.ShapeFile[] shapefiles = new Tripodmaps.Reader.ShapeFile[_map.ShapeFileCount];
